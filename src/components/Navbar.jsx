...
function Navbar() {
  return (
    <div className="w-full  z-[999] px-20 py-8 font-serif flex justify-between items-center" >
      <div className='Logo'><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="links flex gap-10">
                    ...
                    (<a key={index} className={`text-lg  capitalize font-light ${index === 4 && "ml-32"}`}>{item}</a>))}</div>
      <div className=''></div>
    </div>
  )
}
